...
python esmif_full_inv.py --db_location './s669_mapped.csv' --output './s669_mapped_preds.csv' > './logs/log_esmif_s669_inv.txt'
#if ! test -e './fireprot_mapped_preds.csv'; then cp './fireprot_mapped.csv' './fireprot_mapped_preds.csv'; fi
#python esmif_wrapper.py --db_location './fireprot_mapped.csv' --output './fireprot_mapped_preds.csv' > './logs/log_esmif_fireprot.txt'
