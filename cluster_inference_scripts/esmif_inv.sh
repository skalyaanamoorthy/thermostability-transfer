...
python esmif.py --db_location './s669_mapped.csv' --output './s669_mapped_preds.csv' --inverse > 'logs/log_esmif_s669_inv.txt'
#if ! test -e './fireprot_mapped_preds.csv'; then cp './fireprot_mapped.csv' './fireprot_mapped_preds.csv'; fi
#python esmif.py --db_location './fireprot_mapped.csv' --output './fireprot_mapped_preds.csv' --inverse > 'log_esmif_inv_fireprot.txt'
