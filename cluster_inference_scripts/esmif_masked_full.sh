...
python esmif_full.py --db_location './s669_mapped.csv' --output './s669_mapped_preds.csv' --masked --multichain_backbone
if ! test -e './fireprot_mapped_preds.csv'; then cp './fireprot_mapped.csv' './fireprot_mapped_preds.csv'; fi
python esmif_full.py --db_location './fireprot_mapped.csv' --output './fireprot_mapped_preds.csv' --masked --multichain_backbone
